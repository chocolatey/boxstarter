...
task Install-ChocoLib {
    exec { .$nugetExe install chocolatey.lib -Version 0.10.4 -OutputDirectory $basedir\Boxstarter.Chocolatey\ }
    ...
    Copy-Item $basedir\Boxstarter.Chocolatey\chocolatey.lib.0.10.4\lib\* $basedir\Boxstarter.Chocolatey\chocolatey
    ...
    Remove-Item $basedir\Boxstarter.Chocolatey\chocolatey.lib.0.10.4 -Recurse -Force

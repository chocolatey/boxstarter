...
task Install-ChocoLib {
    exec { .$nugetExe install chocolatey.lib -Version 0.10.4-beta1-20170323 -Pre -OutputDirectory $basedir\Boxstarter.Chocolatey\ }
    ...
    Copy-Item $basedir\Boxstarter.Chocolatey\chocolatey.lib.0.10.4-beta1-20170323\lib\* $basedir\Boxstarter.Chocolatey\chocolatey
    ...
    Remove-Item $basedir\Boxstarter.Chocolatey\chocolatey.lib.0.10.4-beta1-20170323 -Recurse -Force
